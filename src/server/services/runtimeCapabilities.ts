...
function baseCapabilityEntries(): RuntimeCapabilityMatrixEntry[] {
  return [
    ...
    },
    {
      ...
      evidenceKind: 'type',
      summary:
        'Subreddit launcher has runtime proof; post/comment Apply Policy menus still need target-context proof.',
      evidence: [
        'Subreddit dashboard launcher opened in W13 playtest.',
        'Post/comment Apply Policy menu entries are configured but unproven.',
      ],
      ...
      safeToTest: true,
      canUpdateFromHealthEvents: true,
      nextAction: 'Invoke post and comment menu actions on safe test content.',
    },
    {
