  ...
  return [
    ...
    },
    {
      ...
      evidence: [
        ...
        'Local type-check, lint, test, and build passed in W12.',
      ],
      ...
      destructive: false,
      nextAction:
        'Invoke both post and comment menus in r/modmirror_dev and record targetId/form behavior.',
    },
    {
      ...
      destructive: false,
      nextAction:
        'Run post/comment menu flows against safe test content and compare resolved author/permalink fields.',
    },
    {
      id: 'redis-smoke',
      ...
      destructive: false,
      nextAction:
        'Hit the route in Devvit playtest and record the redacted key/readBack match.',
    },
    {
      ...
      destructive: false,
      nextAction:
        'Hit the route in Devvit playtest and redact usernames/content before committing proof notes.',
    },
    {
      ...
      destructive: false,
      nextAction:
        'Run demo and live scans in playtest, then verify list/detail/compare routes read Devvit Redis.',
    },
    {
      ...
      destructive: false,
      nextAction:
        'Create, propose, review, and adopt a policy in playtest and confirm versions persist after reload.',
    },
    {
      ...
      destructive: false,
      nextAction:
        'Confirm a log-only Apply Policy action in playtest and verify /api/receipts returns it.',
    },
    {
    ...
    },
    {
      ...
      destructive: false,
      nextAction:
        'Generate a packet after a playtest receipt exists and confirm receipt evidence appears.',
    },
    {
      id: 'team-delivery',
      category: 'delivery',
