# Agent Prompt — Wave 02: Target-Aware Policy Recommendation Core

You are assigned Wave 02 of the ModMirror operational overhaul.
...
Use branch/worktree: `overhaul/w02-recommendation-core` unless integration constraints require a dependency branch.
