...
| Runtime verification matrix | runtime verified for safe status paths | W13 `GET /api/runtime-verification`, `runtimeVerification.test.ts`, W13 playtest `v0.0.1.71`, and post-W34 playtest through `v0.0.1.120` | Keep truth labels current after runtime changes. |
